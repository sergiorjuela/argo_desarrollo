...
// Asociar el widget de validación al formulario
              $("#registrarServicioOrden").validationEngine({
        ...
        $(function() {
            $("#registrarServicioOrden").submit(function() {
...
$("#<?php echo $this->campoSeguro('sede')?>").select2();
 ...
 $('#<?php echo $this->campoSeguro('codigo_ciiu')?>').width(300);
...
$("#<?php echo $this->campoSeguro('tipo_poliza')?>").select2();
 ...
 $("#<?php echo $this->campoSeguro('numero_orden')?>").select2();
  $('#<?php echo $this->campoSeguro('tipo_orden')?>').width(200);    
     ...
     $( "#<?php echo $this->campoSeguro('tipo_registro')?>" ).change(function() {
            ...
            switch($("#<?php echo $this->campoSeguro('tipo_registro')?>").val())
            {
                ...
                case '1':
                    ...
                    $("#<?php echo $this->campoSeguro('cargar_servicio')?>").css('display','block');
                    $("#<?php echo $this->campoSeguro('cargue_servicios')?>").css('display','none');
                ...
                break;
                    ...
                    $("#<?php echo $this->campoSeguro('cargar_servicio')?>").css('display','none');
                    $("#<?php echo $this->campoSeguro('cargue_servicios')?>").css('display','block');
